...
public class TestLeaf1 {
    ...
    public void testTextBox() {
        ...
        Assert.assertEquals(disabled, "true", "the field is not enabled");
    }
    ...
    public void testButton() {
        ...
        Assert.assertEquals(x, 240);
        Assert.assertEquals(y, 304);
        String s = driver.findElement(By.xpath("//button[@id=\"color\"]")).getAttribute("style");
        Assert.assertTrue(s.contains("lightgreen"));
...
//        ageGroups.get(key).click();
    ...
    public void testAlert() {
        ...
        Assert.assertEquals(actual, "You should not have enjoyed learning at Genspark as compared to TestLeaf! Right?");
        ...
        Assert.assertEquals(actual1, "You pressed Cancel!");
    ...
    public void testFrames() {
        ...
        Assert.assertEquals(actual, "Hurray! You Clicked Me.");
...
//    }
        ...
        public void testUploadfile () {
            ...
            driver.findElement(By.xpath("//input[@name=\"filename\"]")).sendKeys("C:\\chromedriver.exe");
        }
        ...
        @Test
        public void testWaittoDissapear () {
            ...
            Assert.assertEquals(text, "I know you can do it! Button is disappeared!");
        ...
        public void testWaittoAppear () {
            ...
            Assert.assertEquals(text, "Voila! I'm here Guys");
        ...
        public void testHoverMouse () {
            ...
            driver.switchTo().alert().accept();
            Assert.assertEquals(text2, "You have clicked on WebServices");
        ...
        public void tearDown () {
            driver.quit();
                    ...
                    //Wednesday Mebane apply
                    //all test cases shuould use exel